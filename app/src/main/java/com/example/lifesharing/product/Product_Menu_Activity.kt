...
class Product_Menu_Activity : AppCompatActivity() {
    ...
    private fun initRecycler() {
        ...
        datas.apply {
            add(MenuData(img = R.drawable.camera, location = "울산 무거동", review = "(100)", name = "카메라" , money_keep = 500000, money_day = 10000))
            add(MenuData(img = R.drawable.camera, location = "울산 삼산", review = "(0)", name = "카메라" , money_keep = 500000, money_day = 10000))
